...
class MDSCluster(CephCluster):
    ...
    def set_inter_mds_block(self, blocked, mds_id1, mds_id2):
        ...
        self._one_or_all((mds_id1, mds_id2), set_block, in_parallel=False)
