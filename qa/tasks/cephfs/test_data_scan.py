...
class BacktracelessFileRemoveLostAndFoundDirectory(Workload):
    ...
    def mangle(self):
        self._filesystem.rados(["-p", self._filesystem.get_metadata_pool_name(), "ls"])
        self._filesystem.rados(["-p", self._filesystem.get_metadata_pool_name(), "listomapvals", "4.00000000"])
