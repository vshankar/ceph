...
class ExportMgr:
    ...
    def prepare_opt_block_dict(raw_config_parsed: Dict) -> Dict[str,Any]:
        opt_blocks = {}
        ...
        with self.mgr.rados.open_ioctx(self.rados_pool) as ioctx:
            ...
            for obj in ioctx.list_objects():
                if obj.key.startswith(EXPORT_PREFIX):
                    ...
                    # optional blocks
                    opt_blocks = prepare_opt_block_dict(raw_config_parsed)
    ...
    def _apply_export(
        ...
        ganesha_export = GaneshaExport(new_export, **opt_dict)
