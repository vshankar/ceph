 ...
 *
 * @param cmount the ceph mount handle to use for making the directory.
 * @param dirfd open file descriptor for a directory (or AT_FDCWD)
 ...
 *
 * @param cmount the ceph mount handle to use for creating the link.
 * @param dirfd open file descriptor (or AT_FDCWD)
 ...
 * @returns 0 on success or negative error code on failure.
 */
int ceph_fchmodat(struct ceph_mount_info *cmount, int dirfd, const char *relpath,
 ...
 * @returns 0 on success or negative error code on failure.
 */
int ceph_fchownat(struct ceph_mount_info *cmount, int dirfd, const char *relpath,
