...
public:
  ...
  void notify_peer_update(const std::string &instance_id,
...
private:
  ...
  void handle_peer_update(const std::string &old_mirror_uuid,
                          const std::string &new_mirror_uuid,
                          Context *on_finish);
  ...
  void handle_payload(const std::string &instance_id,
                      ...
                      C_NotifyAck *on_notify_ack);
  void handle_payload(const std::string &instance_id,
                      const instance_watcher::PeerUpdatePayload &payload,
                      C_NotifyAck *on_notify_ack);
  void handle_payload(const std::string &instance_id,
