...
#ifndef CEPH_RBD_MIRROR_IMAGE_MAP_MAP_IMAGE_REQUEST
#define CEPH_RBD_MIRROR_IMAGE_MAP_MAP_IMAGE_REQUEST
...
public:
  static MapImageRequest *create(
    ...
    return new MapImageRequest(
      ioctx, mirror_uuid, instance_id, global_id, image_id,
      instance_watcher, bootstrap, on_finish);
  }
...
#endif // CEPH_RBD_MIRROR_IMAGE_MAP_MAP_IMAGE_REQUEST
