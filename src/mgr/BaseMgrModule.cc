...
ceph_add_mds_perf_query(BaseMgrModule *self, PyObject *args)
{
  ...
  static const std::map<std::string, MDSPerformanceCounterType> counter_types = {
    {"cap_hit_metric", MDSPerformanceCounterType::CAP_HIT_METRIC},
    {"osdc_cache_metric", MDSPerformanceCounterType::OSDC_CACHE_METRIC},
    {"iops_metric", MDSPerformanceCounterType::IOPS_METRIC},
  };
