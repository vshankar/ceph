...
#ifndef CEPH_LIBRBD_CREATE_REQUEST_H
#define CEPH_LIBRBD_CREATE_REQUEST_H
...
private:
  ...
  void complete(int r);
  Context *finish(int *result);

  // helper
  void shut_down_and_cleanup_journaler(Context *ctx);
  ...
  Context *handle_shut_down_journaler(int *result);
...
#endif // CEPH_LIBRBD_CREATE_REQUEST_H
